...
function useScrollHeight(ref, _temp) {
  ...
  var _useState = React.useState('100vh'),
      scrollHeight = _useState[0],
      setScrollHeight = _useState[1];

  var currentScrollHeight = React.useRef(scrollHeight);
...
function CollapsibleContent(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", _extends({}, others, {
    style: _extends({
      overflow: 'hidden',
...
exports.useScrollHeight = useScrollHeight$1;
