...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Grid__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Path__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Points__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Axis__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Labels__ = __webpack_require__(14);
...
var Svg = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].svg(_templateObject);
...
var LineChart = function (_React$Component) {
  ...
  LineChart.prototype.getMaxY = function getMaxY() {
    ...
    var maxY = data.length > 0 ? data.reduce(function (max, point) {
  ...
  LineChart.prototype.getSvgX = function getSvgX(x) {
    ...
    return round((x - minX) / (maxX - minX) * (Math.abs(viewBoxWidth) - paddingLeft));
  };
  ...
  LineChart.prototype.render = function render() {
    var _props4 = this.props,
        ...
        props = _objectWithoutProperties(_props4, ["viewBoxHeight", "viewBoxWidth"]);
    ...
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_Grid__["a" /* default */], _extends({}, props, commonProps)),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_Path__["a" /* default */], _extends({}, props, commonProps)),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__components_Axis__["a" /* default */], _extends({}, props, commonProps)),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_Points__["a" /* default */], _extends({}, props, commonProps)),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_Labels__["a" /* default */], _extends({}, props, commonProps))
      )
    );
  };
...
LineChart.propTypes = _extends({
  ...
  viewBoxHeight: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  viewBoxWidth: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number
}, __WEBPACK_IMPORTED_MODULE_3__components_Grid__["a" /* default */].propTypes, __WEBPACK_IMPORTED_MODULE_6__components_Axis__["a" /* default */].propTypes, __WEBPACK_IMPORTED_MODULE_5__components_Points__["a" /* default */].propTypes, __WEBPACK_IMPORTED_MODULE_7__components_Labels__["a" /* default */].propTypes);

LineChart.defaultProps = _extends({
  data: [],
  viewBoxHeight: 300,
  viewBoxWidth: 800
}, __WEBPACK_IMPORTED_MODULE_3__components_Grid__["a" /* default */].defaultProps, __WEBPACK_IMPORTED_MODULE_6__components_Axis__["a" /* default */].defaultProps, __WEBPACK_IMPORTED_MODULE_5__components_Points__["a" /* default */].defaultProps, __WEBPACK_IMPORTED_MODULE_7__components_Labels__["a" /* default */].defaultProps);
...
var Wrapper = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].g(_templateObject, function (props) {
...
var Grid = function Grid(_ref) {
  ...
  if (gridVisible) {
    ...
    for (var i = minX; i <= maxX; i++) {
      gridX.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("line", {
        key: i,
        x1: getX(i),
        y1: getY(minY),
        x2: getX(i),
    ...
    for (var _i = minY; _i <= maxY; _i += Math.floor(maxY / yStep)) {
      gridY.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("line", {
        key: _i,
        x1: getX(minX),
        y1: getY(_i),
        x2: getX(maxX),
...
Grid.propTypes = {
  getX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  getY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  gridColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  gridOpacity: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  gridVisible: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool,
  gridWidth: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  labelsCountY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  maxX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  maxY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  minX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  minY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number
};
...
var SvgArea = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].path(_templateObject, function (props) {
  return props.color;
}, function (props) {
  return props.opacity;
});

var SvgPath = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].path(_templateObject2, function (props) {
  return props.opacity;
}, function (props) {
  return props.width;
}, function (props) {
...
var Path = function (_React$Component) {
  ...
  Path.prototype.render = function render() {
    ...
    return pathVisible || areaVisible ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
      "g",
      null,
      pathVisible && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(SvgPath, {
        d: this.getPath(),
        opacity: pathOpacity,
        color: pathColor,
        width: pathWidth
      }),
      areaVisible && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(SvgArea, {
        d: this.getAreaPath(),
        color: areaColor,
        opacity: areaOpacity
      })
...
Path.propTypes = {
  areaColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  areaOpacity: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  areaVisible: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool,
  data: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.shape({
    x: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
    y: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number
  })).isRequired,
  getX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  getY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  pathColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  pathOpacity: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  pathSmoothing: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  pathVisible: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool,
  pathWidth: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number
};
...
var Point = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].circle(_templateObject, function (props) {
  return props.color;
}, function (props) {
...
var Zone = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].rect(_templateObject2);
...
var Points = function Points(_ref) {
  ...
  return pointsVisible ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
    "g",
    null,
    data.map(function (point, i) {
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(Point, {
        key: i,
...
Points.propTypes = {
  ...
  minX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  minY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  pointsColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  pointsIsHoverOnZone: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool,
  pointsOnHover: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  pointsRadius: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  pointsStrokeColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  pointsStrokeWidth: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  pointsVisible: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool
};
...
var SvgGroup = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].g(_templateObject, function (props) {
  return props.color;
}, function (props) {
  return props.width;
}, function (props) {
...
var Axis = function Axis(_ref) {
  ...
  return axisVisible ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
    SvgGroup,
    { color: axisColor, width: axisWidth, opacity: axisOpacity },
    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("line", { x1: getX(minX), y1: getY(minY), x2: getX(maxX), y2: getY(minY) }),
    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("line", { x1: getX(minX), y1: getY(minY), x2: getX(minX), y2: getY(maxY) })
  ) : null;
};

Axis.propTypes = {
  axisColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  axisOpacity: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  axisVisible: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool,
  axisWidth: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  getX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  getY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  maxX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  maxY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
...
var Label = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].g(_templateObject, function (props) {
  return props.color;
});
  ...
  if (labelsVisible) {
    ...
    xLabels = xLabelsRange.map(function (x) {
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("circle", { r: "2", cx: getX(x), cy: getY(0) }),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
          "text",
          {
            x: getX(x),
    ...
    yLabels = yLabelsRange.map(function (y) {
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("circle", { r: "2", cx: getX(minX), cy: getY(y) }),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
          "text",
          {
            x: getX(minX),
    ...
    return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
      "g",
      null,
      xLabels && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        "g",
        null,
        xLabels
      ),
      yLabels && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        "g",
        null,
        yLabels
      )
...
Labels.propTypes = {
  getX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  getY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  labelsColor: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.string,
  labelsCountY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  labelsFormatX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  labelsFormatY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.func,
  labelsHeightX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  labelsOffsetX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  labelsOffsetY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  labelsStepX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  labelsVisible: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.bool,
  maxX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  maxY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  minX: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number,
  minY: __WEBPACK_IMPORTED_MODULE_0_prop_types___default.a.number
